...
/// HelperColors
  final Color generalWhite = const Color(0xffFFFFFF);
  final Color generalTrans = Colors.transparent;
  final MaterialColor generalGrey = Colors.grey;
  final Color generalBlack = const Color(0xff333333);
